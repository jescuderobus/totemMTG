...
// Definimos el reloj que va hacia atras

var options = {
    colour: "yellow",
    lineWidth: 1,
    rim: 60,
    rimColour: "rgba(0,0,0,0.2)",
    directionCoefficient: -1,
    markerType: "number",
    markerColour: "rgba(255,0,0,0.6)",
    markerSize: 12,
    centreCircle: true,
    centreCircleColour: "white",
  };
  var blackClock = new clock("ra10_backwards-clock", options);
  blackClock.start();
